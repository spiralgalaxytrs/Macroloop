...
const ItCtaArea = ({ location }) => {
   return (
      <>
         <div className="it-cta-area law-cta-area about-me-cta-area py-lg-5 py-md-5 pt-1 dark-bg"
         >
            <div className="container">
               <div className="row align-items-center gap-5 gap-lg-0">
                  ...
                  <div className="col-md-6" >
                     ...
                     <div className="it-cta-form about-cta-form wow tpfadeUp rounded px-4 py-lg-5">
                        <CallToActionForm />
                     </div>
                  </div>
               </div>

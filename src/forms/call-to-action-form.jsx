          ...
          (<div className="input-item-textarea text-center text-success d-flex flex-column justify-content-center align-items-center" style={{ "fontWeight": 700 }}>
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="input-item">
                  ...
                  <input
                    ...
                    className={`${errors.name ? "border-danger" : ""}border-0`}
                  />
              ...
              <div className="col-lg-6">
                <div className="input-item">
                  ...
                  <input
                    ...
                    className={`${errors.phone ? "border-danger" : ""} border-0`}
                  />
                  <lable>Phone</lable>
                </div>
              ...
              <div className="col-lg-6">
                <div className="input-item">
                  ...
                  <input
                    ...
                    name="org"
                    onChange={handleInputChange}
                    className={`${errors.org ? "border-danger" : ""}border-0`}
                  />
              ...
              {formData.re && formData.isagen &&
                <div className="col-lg-6">
                  <div className="input-item border-2 border-black">
                    <span>
                    ...
                    {menu_data.filter((item) => item.has_dropdown && item.sub_menus).map((item, i) => (
                      <select
                        ...
                        name="agen"
                        onChange={handleInputChange}
                        className={`${errors.agen ? "border-danger " : ""}border-0`}
                      >
                        <option value="" disabled className='d-none border-0'>Select a Requirement</option>
                        {item.sub_menus.map((sub_item, sub_i) => {
                          if (sub_item.title == formData.re && sub_item?.sub && sub_item.sub.length > 0) {
                            return sub_item.sub.map((item, sub_i) => {
                              return (
                                <option key={sub_i} value={item} className="border-0">
                                  {item}
                                </option>
                              )
                            })
